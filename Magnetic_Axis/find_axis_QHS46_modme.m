function [rAxis, current_2p5_tesla] = find_axis_QHS46_modme(coil_current_array, rGuess)
% function [rAxis, current_2p5_tesla] = find_axis_QHS46_modme(current, coil_current_array, rGuess)
...
[bx, by, bz] = calc_b_QHS46_RPhiZ(rAxis, 0, 0, coil_current_array);
