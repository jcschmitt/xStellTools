...
%AU_Blue = [12 35 64]/255; % original
AU_Blue = [30 87 160]/255; % lighter
...
subplot(1,1,1); % superimpose both surfaces.
surf(surf_x_allfp_1(65:196, 1:end), surf_y_allfp_1(65:196, 1:end), surf_z_allfp_1(65:196, 1:end), ...
    ones(size(surf_z_allfp_1(65:196, 1:end))), 'EdgeColor', 'k', 'FaceColor', AU_Blue);
hold on;box on;
surf(surf_x_allfp_2(128:end, 1:end), surf_y_allfp_2(128:end, 1:end), surf_z_allfp_2(128:end, 1:end), ...
    ones(size(surf_z_allfp_2(128:end, 1:end))), 'EdgeColor', 'k', 'FaceColor', AU_Orange);
axis equal;axis tight;view(3);
title('Blue = Init. Surface, Orange = New Surface')
box on ; hold on
grid on
...
subplot(2,2,1); % superimpose both surfaces.
surf(surf_x_allfp_1(1:196, 1:end), surf_y_allfp_1(1:196, 1:end), surf_z_allfp_1(1:196, 1:end), ...
    ones(size(surf_z_allfp_1(1:196, 1:end))), 'EdgeColor', 'k', 'FaceColor', AU_Blue);
hold on;box on;
surf(surf_x_allfp_2(65:end, 1:end), surf_y_allfp_2(65:end, 1:end), surf_z_allfp_2(65:end, 1:end), ...
    ones(size(surf_z_allfp_2(65:end, 1:end))), 'EdgeColor', 'k', 'FaceColor', AU_Orange);
axis equal;axis tight;view(3);
title('Blue = Init. Surface, Orange = New Surface')
box on ; hold on
grid on
