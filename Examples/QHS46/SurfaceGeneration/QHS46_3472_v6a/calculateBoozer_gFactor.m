function g_Boozer = ... 
    calculateBoozer_gFactor(current, rStart, relTol, absTol)

if (nargin < 4) % if you don't specify the tolerances
...
[phi, coords] = ...
    ode113(@Boozer_gFactorDeriv, phiSpan, coords0, options, current);
...
function [dcoords_dphi] = Boozer_gFactorDeriv(phi, coords, current)
