function [surf_x, surf_y, surf_z, phiout] = ...
    calc_descur_RZ_points(rboundary, nphi, ntheta, current, taper)
% function [surf_x, surf_y, surf_z, phiout] = ...
%     calc_descur_RZ_points(rboundary, nphi, ntheta, current, taper)
% inputs:
...
%
%
% The original version of this goes back to J. Canik @ HSX; It was 
% later modified by J. Lore @ HSX.
% This version is a minor revision.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% hardcoded and work well for HSX, but they should be check/verified for other cases. 
options = odeset('RelTol', 1e-10, 'AbsTol', 1e-10);

% The output 'xout' is [r z]
% Perform the field line following.
[phiout, xout] = ode45(@field_line_derivs, phi_points, x0, options, current, taper); 
...
[bx, by, bz] = calc_b_HSX_RPhiZ(r, phi, z, current, taper);
