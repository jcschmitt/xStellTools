function [] = make_descur_file_HSX(LCFS_filename, LCFS_pathname, N_phi, N_theta)
% function [] = make_descur_file_HSX(LCFS_filename, LCFS_pathname)
...
% select a file.
%
% Original version by J. Canik. Modified by J. Lore.
% Automation added by J. Schmitt.
...
try
    ...
    warning('error in make_descur_file_HSX.m');
    LCFS_filename
    LCFS_pathname
    cd(cur_pwd);
    fclose(fid);
