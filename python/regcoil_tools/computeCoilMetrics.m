...
regcoil_out_filename = '/Users/elizabethpaul/Documents/Research/Fall_2017/20171207_surfacesForPaper/highResForCurvature/W7X_opt/regcoil_out.w7x.nc';
nescin_filename = '/Users/elizabethpaul/Documents/Research/Fall_2017/20171207_surfacesForPaper/highResForCurvature/W7X_opt/nescin.w7x_winding_surface_from_Drevlak_5165';
coilsPerHalfPeriod = 5;

% HSX
% regcoil_out_filename = '/Users/elizabethpaul/Documents/Research/Fall_2017/20171207_surfacesForPaper/highResForCurvature/HSX_init/ntheta_nzeta_400/regcoil_out.hsx.nc';
% nescin_filename = '/Users/elizabethpaul/Documents/Research/Fall_2017/20171207_surfacesForPaper/highResForCurvature/HSX_init/ntheta_nzeta_400/nescin_clone_actual.txt.changesign_0';
...
fprintf('min_dist: %d\n', min(min_dist));
fprintf('mean extent: %d\n', mean(extent));
fprintf('max extent: %d\n', max(extent));
fprintf('mean length: %d\n', mean(coilLength));
fprintf('max length: %d\n', max(coilLength));
fprintf('mean_curvature (arclength): %d\n', mean(mean_curv_s));
fprintf('max curvature (arclength): %d\n', max(max_curv_s));
fprintf('mean_curvature (theta): %d\n', mean(mean_curv_theta));
fprintf('max curvature (theta): %d\n', max(max_curv_theta));
